...
import { app, protocol, ipcMain, Tray, nativeImage, screen, session, BrowserWindow, Menu } from 'electron';
...
let MusicSystem = {
	...
	MainWindow: data => {
		...
		appTray = new Tray(path.join(__static, 'icon/tray@3x.png')); //加@2x可解决mac显示异常问题
		//图标的上下文菜单
