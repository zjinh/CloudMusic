	...
	<div class="cm-page-main" @scroll="loadMore">
		<div class="cm-video-left">
			...
			<ButtonArea class="video-button-area">
				...
				<button @click="downloadVideo" class="sf-icon-arrow-to-bottom">
					下载
				</button>
			</ButtonArea>
			...
			<CommentList :data="commentData" :loading="loading" :type="videoType" />
		</div>
		<div class="cm-video-right">
			...
			<VideoList :data="relatedVideo" type="self" @callback="init" />
		</div>
		<BackToTop />
	</div>
</template>
...
import VideoPlayer from '../../components/MusicCom/VideoPlayer';
