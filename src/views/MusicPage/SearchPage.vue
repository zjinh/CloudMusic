<template>
  <div class="cm-page-main">
    ...
    <div class="cm-search-main">
      ...
      ></SongList>
      <ArtistList
        v-show="nowSearchType[0] === 'artists'"
        :data="searchResult.artists"
        :loading="loading"
        @scroll-end="loadMore"
      ></ArtistList>
      <PlayList
        v-show="nowSearchType[0] === 'playlists'"
        :data="searchResult.playlists"
        :loading="loading"
        @scroll-end="loadMore"
      ></PlayList>
      <AlbumList
        v-show="nowSearchType[0] === 'albums'"
        :data="searchResult.albums"
        :loading="loading"
        @scroll-end="loadMore"
      ></AlbumList>
      <VideoList
        v-show="nowSearchType[0] === 'videos'"
        :data="searchResult.videos"
        :loading="loading"
        @scroll-end="loadMore"
      ></VideoList>
      <RadioList
        v-show="nowSearchType[0] === 'djRadios'"
        :data="searchResult.djRadios"
        :loading="loading"
        @scroll-end="loadMore"
      ></RadioList>
      <UserList
        v-show="nowSearchType[0] === 'userprofiles'"
        :data="searchResult.userprofiles"
        :loading="loading"
        @scroll-end="loadMore"
      ></UserList>
    </div>
