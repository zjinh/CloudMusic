<template>
  <div class="cm-page-main" id="cm-artist-detail" @scroll="loadMore">
    ...
    <div class="cm-artist-detail-main">
      <SongList
        v-show="nowType.type === 'music'"
        :data="artistDetail.music"
        :loading="loading"
      ></SongList>
      <VideoList
        v-show="nowType.type === 'mv'"
        :data="artistDetail.mv"
        :loading="loading"
      ></VideoList>
      <ArtistList
        v-show="nowType.type === 'simi'"
        :data="artistDetail.simi"
        @callback="init"
        :loading="loading"
      ></ArtistList>
    </div>
...
export default {
  ...
  methods: {
    ...
    getArtistData(page) {
      ...
      this.$Api.Music.artist[this.nowType.type](
