    ...
    <div class="cd-about-win">
        ...
        <div class="cd-about-main">
            ...
            <div class="bottom">
                ...
                <button class="cm-cancel-button" @click="OpenLink">项目地址</button>
            </div>
        </div>
    </div>
</template>
...
<script>
    import WindowsHeader from "./MusicWindow/WindowHeader";
    export default {
        name: "MusicAbout",
        data(){
            return{
        ...
        methods:{
            ...
            OpenLink(){
                this.$electron.shell.openExternal('https://github.com/zjinh/CloudMusic/')
            }
        }
    }
</script>
...
<style scoped>
    ...
    .app-icon{
        background: transparent url("../../../static/img/bar/music.png");
        position: absolute;
        top: 10px;
        right: 40px;
        background-size: 100%;
