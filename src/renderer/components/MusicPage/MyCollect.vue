<template>
    <div class="cm-page-main">
        <TabBar :data="collectType" @select="tabBarSelect"></TabBar>
        <div class="cm-collect-main">
            <AlbumList v-show="nowCollectType[0]==='album'" :data="collectResult.album" :loading="loading" @scroll-end="loadMore"></AlbumList>
            <ArtistList v-show="nowCollectType[0]==='artist'" :data="collectResult.artist" :loading="loading" @scroll-end="loadMore"></ArtistList>
            <PlayList v-show="nowCollectType[0]==='playlist'" :data="collectResult.playlist" :loading="loading" @scroll-end="loadMore"></PlayList>
            <VideoList v-show="nowCollectType[0]==='mv'" :data="collectResult.mv" :loading="loading" @scroll-end="loadMore"></VideoList>
        </div>
    </div>
</template>
...
<script>
    ...
    export default {
        name: "MyRadio",
        components:{
            AlbumList,ArtistList,PlayList,VideoList
        },
        data(){
            return{
                collectType:[
